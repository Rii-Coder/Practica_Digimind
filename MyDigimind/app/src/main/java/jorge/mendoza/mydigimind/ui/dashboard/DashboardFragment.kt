package jorge.mendoza.mydigimind.ui.dashboard
...
import jorge.mendoza.mydigimind.ui.home.HomeFragment
...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root.btn_save.setOnClickListener{
            ...
            Toast.makeText(root.context, "new Task added", Toast.LENGTH_LONG)
